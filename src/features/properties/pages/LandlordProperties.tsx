      ...
      <div className="p-4">
        ...
        {property.tenantInfo && (
          <div className="mt-4 pt-4 border-t">
            <h4 className="text-sm font-medium text-gray-900">Current Tenant</h4>
            <p className="text-sm text-gray-500">{property.tenantInfo.name}</p>
            <p className="text-sm text-gray-500">
              Lease: {property.tenantInfo.leaseStart} - {property.tenantInfo.leaseEnd}
            </p>
          </div>
        )}
      </div>
